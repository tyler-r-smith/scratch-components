import {addClass, removeClass, hasClass} from './lib/class.js'
import {mousePositionInElem, mousePositionInElemRightAlign} from './lib/mousePosInEle.js'
import {absoluteParent} from './lib/absoluteParent.js'
    ...
    constructor(elem, options) {
        ...
        this.mouseMove = (e) => {
            ...
            if (hasClass(parent, "constrainDrag")) {
                console.log(parent.offsetLeft, parent.offsetWidth, top, left);
                if (left < 0) left = 0;
        ...
        this.elem.addEventListener('mousedown', (e)=>{
            if (options.resize) {
                ...
                console.log("Should she be resized", mousePos);
