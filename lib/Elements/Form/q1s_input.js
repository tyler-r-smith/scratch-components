...
import input_styles from '../../css/q1s_inputs.js';
...
export class q1s_input extends q1s {
    constructor(obj){
        ...
        this.addFunctionToCallback(function(){
            ...
            const styleSheet = this.parent.styles || input_styles;
            this.parent.addElementToShadow(this.parent.styleSheet(styleSheet));
